function validar() {
    ...
    let matutino = document.getElementById("matutino").checked;
    let vespertino = document.getElementById("vespertino").checked
    let noturno = document.getElementById("noturno").checked;
